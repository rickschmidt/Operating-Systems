...
plot(c(1:10),y1$io,col="red",type="l",main="IO Times",xlab="Iterations",ylab="IO Time (seconds)")
...
plot(c(1:10),y1$mix,col="red",type="l",main="Mix Times",xlab="Iterations",ylab="Mix Time (seconds)")
...
barplot(sdcpu,main="SD CPU",col=colors)
barplot(sdio,main="SD IO",col=colors)
barplot(sdmix,main="SD MIX",col=colors)
barplot(meancpu,main="MEAN CPU",col=colors)
barplot(meanio,main="MEAN IO",col=colors)
barplot(meanmix,main="MEAN MIX",col=colors)
